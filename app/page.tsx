    ...
    <div className={styles.shell}>
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <section id="tester" className={styles.section}><SectionLabel n="10">Live Model Tester</SectionLabel><div className={styles.tester}><div><h2>Test the implemented detector</h2><p>Return to the live prompt interface to submit a prompt to the project's prediction endpoint and inspect its classification.</p></div><Link href="/detector" className={styles.primaryBtn}>Open detector →</Link></div></section>
